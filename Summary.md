...
<p>	A ordenação tem como objetivo organizar os dados listados em ordem crescente ou decrescente assim facilitando a recuperação destes dados em um determinado conjunto a que pertencem, deste modo auxiliando a busca e pesquisa dos dados.</p>
	<p>Imaginamos que em um sistema de contatos onde há várias pessoas cadastradas, retornando todos seus com uma ordenação facilita a busca da informação necessária para tal pessoa</p>
		  

	  

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDE4MTA4OTUsNzIyNjg3OTAwLC0xNj
